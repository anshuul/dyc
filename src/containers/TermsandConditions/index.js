                    ...
                    <Row className='banner-row'>
                        <Col md='7' lg='8'>
                            <div className='banner-left'>
                                <div>
                                    <h1 data-aos='fade-right' data-aos-duration="900">Terms and <br /> Conditions</h1>
                                ...
                                <div className='bottom-link'>
                                    ...
                                    <Link to='/privacy-policy'>
                                        Privacy Policy <SvgIcon className='right-arrow' name='chevron-right' viewbox='0 0 4.029 6.932' />
                                    </Link>
                                </div>
                            </div>
                        </Col>
