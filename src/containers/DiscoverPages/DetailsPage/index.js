...
import { Button, Checkbox, Form, Input, Select, Progress, Dropdown, DatePicker, Modal, Drawer, Popover } from 'antd';
...
const QaModal = () => {
    ...
    return (
        <>
            ...
            <Modal centered title="Q & A" footer={false} className='qa-modal' open={isModalOpen} onOk={handleOk} onCancel={handleCancel}>
                <div>
                    <Form
                        name="basic"
                        autoComplete="off"
                ...
                <Container className='container-upper'>
                            ...
                            <div className='highlights-row'>
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <div>
                                            Stand above the clouds as you catch a closeup view of the pyramidal
                                        </div>
                                    </li>
                                    <li>
                                        <div className='left-icon'>
                                        ...
                                        <div>
                                            Immerse yourself into discovery in the Observation Deck on the 86th Floor
                                        </div>
                                    </li>
                                    <li>
                                        <div className='left-icon'>
                                        ...
                                        <div>
                                            Standing as one of best spots to view the city of Kuala Lumpur
                                        </div>
                                    </li>
                                    <li>
                                        <div className='left-icon'>
                                ...
                                >
                                    <div className='prive-details-form'>
                                        ...
                                        <div className='options-colum'>
                                            ...
                                            <ul>
                                                <li>
                                                    <Popover placement="bottomLeft" arrow={false} overlayClassName='options-list-popover' content={"The Tower of London, officially His Majesty's Royal Palace and Fortress of the Tower of London, is a historic castle on the north bank of the River Thames in central London, England"} title="Explore Magic Imagica">
                                                ...
                                                <li>
                                                    <Popover placement="bottomLeft" arrow={false} overlayClassName='options-list-popover' content={"The Tower of London, officially His Majesty's Royal Palace and Fortress of the Tower of London, is a historic castle on the north bank of the River Thames in central London, England"} title="Tower Bridge">
                                                ...
                                                <li>
                                                    <Popover placement="bottomLeft" arrow={false} overlayClassName='options-list-popover' content={"The Tower of London, officially His Majesty's Royal Palace and Fortress of the Tower of London, is a historic castle on the north bank of the River Thames in central London, England"} title="London Eye">
                    ...
                    <div className='details-experiences'>
                        ...
                        <div className='operatinghours-row'>
                            ...
                            <ul>
                                <li>Monday <label>10:00 - 19:00</label></li>
                                <li>Tuesday <label>10:00 - 19:00</label></li>
                                <li>Wednesday <label>10:00 - 19:00</label></li>
                                <li>Thursday <label>10:00 - 19:00</label></li>
                                <li>Friday <label>10:00 - 19:00</label></li>
                                <li>Saturday <label>10:00 - 19:00</label></li>
                                <li>Sunday <label>10:00 - 19:00</label></li>
                            </ul>
                        </div>
                        <div className='whatexpect-row'>
                            ...
                            <ul>
                                <li>
                                    ...
                                    Chance to see the world’s tallest building up-close </li>
                                <li>
                                    <div className='check-circle'>
                                        <SvgIcon name='check' viewbox='0 0 10.289 9.742' />
                                    </div>
                                    Get access to the observation decks at 124th and 125th levels </li>
                                <li>
                                    <div className='check-circle'>
                                        <SvgIcon name='check' viewbox='0 0 10.289 9.742' />
                                    </div>
                                    Use the cutting-edge telescopes for closer views of Dubai’s major landmarks </li>
                                <li>
                                    <div className='check-circle'>
                                        <SvgIcon name='check' viewbox='0 0 10.289 9.742' />
                                    </div>
                                    Safety Verified as it complies with all COVID-19 preventive measures imposed by both WHO and the government</li>
                            </ul>
                        </div>
                        <div className='whatexpect-row thing-note'>
                            ...
                            <ul>
                                <li>
                                    ...
                                    Familiarize yourself with cancellation and refund policies  </li>
                                <li>
                                    <div className='check-circle'>
                                        <SvgIcon name='check' viewbox='0 0 10.289 9.742' />
                                    </div>
                                    Check if the package can be customized to your needs.  </li>
                                <li>
                                    <div className='check-circle'>
                                        <SvgIcon name='check' viewbox='0 0 10.289 9.742' />
                                    </div>
                                    Compare the bundled price with individual costs. </li>
                                <li>
                                    <div className='check-circle'>
                                        <SvgIcon name='check' viewbox='0 0 10.289 9.742' />
                                    </div>
                                    Take note of the package’s usage timeframe.</li>
                            </ul>
                        </div>
