            ...
            <div className='tab-content profile-setting' data-aos='fade-in' data-aos-duration="800">
                ...
                >
                    <div className='change-profile-row'>
                        <div className='profile-img'><img src={userImg} alt='' /> </div><Button type='text'>Change Photo</Button>
                    </div>
                    ...
                    <Form.Item className='icon-less'>
                        <FloatLabel label="Date of Birth" name="dob" value={dob}>
                            <DatePicker defaultValue={dayjs('2015/01/01', dateFormat)} onChange={e => setDob(e.target.value)} format={dateFormat} />
                        </FloatLabel>
                    </Form.Item>
                    <Form.Item className='icon-less'>
                    ...
                    <Form.Item className='icon-less'>
                        <FloatLabel label="Minimum Spend" name="minimumSpend" value={minimumSpend}>
                            <Input value={minimumSpend} onChange={e => setminimumSpend(e.target.value)} />
                        </FloatLabel>
                    </Form.Item>
